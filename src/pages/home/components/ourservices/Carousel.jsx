  ...
  return (
    <>
      ...
      <div className="relative">
        <div
          className="bg-[gray]/10 backdrop-blur-xl rounded-3xl p-2  border border-slate-200/20 
                           shadow-xl shadow-teal-100/20 overflow-hidden"
        >
          {/* Header del slider */}
          <div className="text-center mb-8">
            <h3 className="text-2xl font-bold text-black-900 mb-2">
              Proyectos Destacados
            </h3>
            <p className="text-lg sm:text-xl lg:text-lg text-slate-600 max-w-4xl mx-auto leading-relaxed ">
                  ...
                  >
                    ...
                    <div className="relative h-48 overflow-hidden">
                      ...
                      <div className="absolute top-4 left-4">
                        <span
                          className="px-3 py-1 bg-white/90 backdrop-blur-sm text-slate-700 
                    ...
                    <div className="p-6">
                      <h4
                        className="text-xl font-bold text-[#ff66c4]/60 mb-2 group-hover:text-[#ff66c4]
