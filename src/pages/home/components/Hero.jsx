export const Hero = () => {
  return (
    <section className="text-center sm:px-6 lg:px-8 py-12 burbuja">
      <>
        ...
        <h1 className="primary-color text-center font-bold text-4xl sm:text-5xl md:text-6xl lg:text-7xl leading-tight ">
          Transformamos ideas en resultados digitales reales
        </h1>
      </>

      <p className="mt-6 max-w-2xl mx-auto text-sm sm:text-base md:text-lg text-gray-950 px-2">
