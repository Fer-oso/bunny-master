...
export const HeroSlider = () => {
    ...
    return (
      <div className={`relative py-20 overflow-hidden transition-all duration-1000 bg-gradient-to-br ${currentSlideData.background}`}>
        ...
        <button
          onClick={prevSlide}
          className="absolute left-8 top-1/2 transform -translate-y-1/2 z-30 bg-white/20 backdrop-blur-sm p-4 rounded-full hover:bg-white/30 transition-all duration-300 text-gray-700 hover:text-gray-900 group"
        >
